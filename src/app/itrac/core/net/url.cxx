...
const char PATH_DEPT_MODIFY[] = "department/modify";
...
const char PATH_USER_RESET_PWD[] = "user/resetPwd";
const char PATH_USER_ADD[] = "user/add";
const char PATH_USER_MODIFY[] = "user/adminModify";
...
const char PATH_PKGTPYE_ADD[] = "packageType/add";
const char PATH_PKGTPYE_PKGIDS[] = "packageType/pkgIds";
const char PATH_PKGTPYE_MODIFY[] = "packageType/modify";
const char PATH_PKGTPYE_UPLOAD_IMG[] = "packageType/uploadPhoto";
const char PATH_PKGTPYE_DOWNLOAD_IMG[] = "packageType/photo";
...
const char PATH_INSTRUMENT_INSIDS[] = "instrument/insIds";
const char PATH_INSTRUMENT_UPLOAD_IMG[] = "instrument/uploadPhoto";
const char PATH_INSTRUMENT_DOWNLOAD_IMG[] = "instrument/photo";
const char PATH_INSTRUMENT_MODIFY[] = "instrument/modify";
...
const char PATH_EXT_PROCESS[] = "ext/extProcess";
