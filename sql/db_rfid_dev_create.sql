...
CREATE TABLE IF NOT EXISTS `t_package_detail` (
  ...
  `pkg_cycle_stamp` int unsigned NOT NULL, -- cycle when binding
  `ins_udi` varchar(32) NOT NULL,
  `ins_cycle_stamp` int unsigned NOT NULL, -- cycle when binding
...
-- `r_package` recoreds package status, as well as a snapshot of the static package properties
...
CREATE TABLE IF NOT EXISTS `r_recycle` (
  ...
  `from_dept_name` varchar(32) NOT NULL,
  `op_id` int NOT NULL,
